...
public class MobilityHeuristicMinimaxOption implements Option {

  private static final int MAX_DEPTH = 4; // suchtiefe, anpassbar

  @Override
  public boolean isBoardInInitiationSet(Board board, PLAYER_COLOR playerColor) {
    return true; // kann jederzeit gestartet werden
  }
  ...
  /**
   * Bewertungsfunktion:
   * Ziel = Gegner hat möglichst wenige Züge.
   */
  private int evaluate(Board board, PLAYER_COLOR maximizingPlayer) {
    int myMoves = Long.bitCount(board.generateAllPossibleMoves(maximizingPlayer == PLAYER_COLOR.WHITE));
    int oppMoves = Long.bitCount(board.generateAllPossibleMoves(maximizingPlayer != PLAYER_COLOR.WHITE));

    return (myMoves - oppMoves) * 10; // Gewichtung für Mobilität
  }

  @Override
  public String getName() { return "MobilityHeuristicMinimax"; }

  @Override
  public String toString() {return "MobilityHeuristicMinimax"; }
}
